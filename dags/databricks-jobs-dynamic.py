"""
### Run notebooks in databricks as a Databricks Workflow 
...
DATABRICKS_NOTEBOOK_NAME_1 = "1_bronze_layer"
DATABRICKS_NOTEBOOK_NAME_2 = "2_silver_layer"
DATABRICKS_NOTEBOOK_NAME_2 = "3_gold_layer"
...
DATABRICKS_NOTEBOOK_PATH_3 = (
    f"/Users/{DATABRICKS_LOGIN_EMAIL}/{DATABRICKS_NOTEBOOK_NAME_3}"
)
...
@dag(start_date=datetime(2024, 10, 25), schedule=None, catchup=False)
def my_simple_databricks_dag():
    ...
    with task_group:
        ...
        notebook_3 = DatabricksNotebookOperator(
            ...
            databricks_conn_id=DATABRICKS_CONN_ID,
            notebook_path=DATABRICKS_NOTEBOOK_PATH_3,
            source="WORKSPACE",
            job_cluster_key=DATABRICKS_JOB_CLUSTER_KEY,
        )
